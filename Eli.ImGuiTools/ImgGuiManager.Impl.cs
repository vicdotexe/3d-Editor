...
{
    public partial class ImGuiManager : GlobalManager, IFinalRenderDelegate
    {
        [Flags]
        enum WindowPosition
        {
        ...
        void DrawGameWindow()
        {
            ...
            /*
            args.X = (int) _gameWindowFirstPosition.X;
            args.Y = (int) _gameWindowFirstPosition.Y;
            args.Width = (int) (((float)Screen.Width / 2) / rtAspectRatio);
            args.Height = (int) (((float)Screen.Height / 2) / rtAspectRatio);
            AdjustViewport?.Invoke(this, args);
            */
        ...
        public override void OnEnabled()
        {
            if (Core.Scene != null)
            {
                Core.FinalRenderDelegate = this;
                //((BaseEliScene) Core.Scene).OnSceneViewportChange;
        ...
        public static bool IsGameWindowHovered;
                                                    ...
                                                    SamplerState samplerState)
        {
            if (ShowSeperateGameWindow)
            {
                ...
                ImGui.Begin(_gameWindowTitle, _gameWindowFlags | ImGuiWindowFlags.MenuBar);
