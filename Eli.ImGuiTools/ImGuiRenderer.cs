...
using ImFontPtr = ImGuiNET.ImFontPtr;
...
namespace Eli.ImGuiTools
{
	...
	public class ImGuiRenderer
	{
        ...
        {
            return _instance.BindTexture(texture);
        }

        public static void UnBind(IntPtr textureId)
        {
			_instance.UnbindTexture(textureId);
        }

        public static IntPtr BindSafe(Texture2D texture, IntPtr textureId)
        {
            if (_instance._loadedTextures[textureId] == null)
            {
                return Bind(texture);
            }
