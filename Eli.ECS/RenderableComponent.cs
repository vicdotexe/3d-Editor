...
namespace Eli.ECS
{
	...
	public abstract class RenderableComponent : Component, IRenderable, IComparable<RenderableComponent>
	{
		...
		public abstract void Render(Batcher batcher, ICamera camera);
		...
		/// <param name="camera">Camera.</param>
		public virtual bool IsVisibleFromCamera(ICamera camera)
		{
		...
		{
			Material = material;
			if (Entity != null && Entity._world != null)
				Entity._world.RenderableComponents.SetRenderLayerNeedsComponentSort(RenderLayer);
			return this;
		}
		...
		public RenderableComponent SetRenderLayer(int renderLayer)
		{
			if (renderLayer != _renderLayer)
			{
				...
				if (Entity != null && Entity._world != null)
					Entity._world.RenderableComponents.UpdateRenderableRenderLayer(this, oldRenderLayer, _renderLayer);
			}
