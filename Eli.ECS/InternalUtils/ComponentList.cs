...
namespace Eli.ECS.InternalUtils
{
	public class ComponentList
	{
		...
		public ComponentList(BaseEntity entity)
		{
			_entity = entity;
		}
		...
		internal void DeregisterAllComponents()
		{
			for (var i = 0; i < _components.Length; i++)
			{
				...
				if (component is RenderableComponent)
					_entity._world.RenderableComponents.Remove(component as RenderableComponent);
		...
		internal void RegisterAllComponents()
		{
			for (var i = 0; i < _components.Length; i++)
			{
				var component = _components.Buffer[i];
				if (component is RenderableComponent)
					_entity._world.RenderableComponents.Add(component as RenderableComponent);
		...
		internal void DebugRender()
		{
			...
			{
				if (_components.Buffer[i].Enabled)
					_components.Buffer[i].DebugRender();
			}
		}
	}
}
