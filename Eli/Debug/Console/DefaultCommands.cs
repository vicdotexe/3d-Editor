...
namespace Eli.Console
{
	public partial class DebugConsole
	{
        ...
        */
		...
		[Command("assets", "Logs all loaded assets. Pass 'scene' for scene assets or 'global' for global assets")]
		static void LogLoadedAssets(string whichAssets = "global")
		{
			if (whichAssets == "scene")
				Instance.Log(Core.Scene.Content.LogLoadedAssets());
			else if (whichAssets == "global")
        ...
        */
		...
		static void Physics(float secondsToDisplay = 5f)
		{
			...
			Instance.Log("Physics system collider count: " +
			                          ((HashSet<Collider>) Eli.Physics.GetAllColliders()).Count);
		}
        */
