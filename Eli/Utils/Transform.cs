...
namespace Eli
{
    ...
    public abstract class Transform3WithOwner<T> : Transform3 where T : ITransformable3D
    {
        public T Owner { get; set; }
        public Transform3WithOwner(T owner)
        {
            Owner = owner;
        }
    }
        ...
        where TMatrix : struct
    {
        ...
        protected List<BaseTransform<TMatrix>> _children = new List<BaseTransform<TMatrix>>();
        ...
        public virtual BaseTransform<TMatrix> GetChild(int index)
        {
