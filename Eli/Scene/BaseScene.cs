...
namespace Eli.ECS
{
    public abstract class BaseScene: IScene
    {
        ...
        public Rectangle RenderDestination => _finalRenderDestinationRect;
        #endregion
        ...
        internal FastList<BaseRenderer> _renderers = new FastList<BaseRenderer>();
        internal readonly FastList<BaseRenderer> _afterPostProcessorRenderers = new FastList<BaseRenderer>();
        ...
        public void Begin()
        {
            ...
            {
                Insist.AreNotEqual(_renderers.Length, 0, "Scene has begun with no renderer");
            }
        ...
        public virtual RenderTarget2D PostRender()
        {
            ...
            return Mathf.IsEven(enabledCounter) ? _sceneRenderTarget : _destinationRenderTarget;
        ...
        void UpdateResolutionScaler()
        {
            ...
            if (Core.FinalRenderDelegate != null)
                Core.FinalRenderDelegate.OnSceneBackBufferSizeChanged(renderTargetWidth, renderTargetHeight);
        ...
        public T AddRenderer<T>(T renderer) where T : BaseRenderer
        {
