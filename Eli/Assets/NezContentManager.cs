...
namespace Eli
{
	...
	/// </summary>
	public partial class NezContentManager : ContentManager
	{
        ...
        //TODO: Implement 2D Particle System
        /*
		/// <summary>
        ...
        */
		...
		/// </summary>
		public SpriteAtlas LoadSpriteAtlas(string name, bool premultiplyAlpha = false, bool trackTexture = true)
		{
			if (LoadedAssets.TryGetValue(name, out var asset))
			{
            ...
            SpriteAtlas atlas;
			if (!trackTexture)
			    atlas = SpriteAtlasLoader.ParseSpriteAtlas(name, premultiplyAlpha);
            else
			    atlas = SpriteAtlasLoader.ParseSpriteAtlasTrackedTexture(name, premultiplyAlpha, this);
	...
	/// </summary>
	public class NezGlobalContentManager : NezContentManager
	{
