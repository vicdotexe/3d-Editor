...
namespace Eli.Sprites
{
	public static class SpriteAtlasLoader
	{
        ...
        public static SpriteAtlas ParseSpriteAtlasTrackedTexture(string dataFile, bool premultiplyAlpha, NezContentManager contentManager)
        {
            var spriteAtlas = ParseSpriteAtlasData(dataFile);
            return spriteAtlas.AsSpriteAtlas(contentManager.LoadTexture(dataFile.Replace(".atlas", ".png"), premultiplyAlpha));
        }
